  ...
  return (
    <div>
      ...
      <p className="text-sm text-brand-charcoal/50 mb-6 max-w-xl">
        Les 4 cartes de référence affichées au-dessus de la liste des pizzas (Classique, Premium, Prestige, Sélection
        Oro). La liste des pizzas elle-même a ses propres prix individuels, modifiables depuis{" "}
